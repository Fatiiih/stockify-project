            ...
            <form action="{{ route('admin.suppliers.update', $supplier) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="address" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-primary-400 focus:border-primary-400">{{ old('address', $supplier->address) }}</textarea>
